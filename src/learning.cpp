...
{
    BOOST_ASSERT(dataStorage->getDimensionality() <= numFeatures);
...
////////////////////////////////////////////////////////////////////////////////
/// ProjectiveRandomForestLearner
////////////////////////////////////////////////////////////////////////////////

ProjectiveRandomForest::ptr ProjectiveRandomForestLearner::learn(AbstractDataStorage::ptr storage)
{
    // Set up the empty random forest
    ProjectiveRandomForest::ptr forest = std::make_shared<ProjectiveRandomForest>();
    ...
    for (int i = 0; i < numTrees; i++)
    {
        ...
        // Learn the tree
        ProjectiveDecisionTree::ptr tree = treeLearner.learn(storage);
        // Add it to the forest
        #pragma omp critical
        {
            state.tree = ++treeFinishCounter;
...
int ProjectiveRandomForestLearner::defaultCallback(ProjectiveRandomForest::ptr forest, const RandomForestLearnerState & state)
{
    switch (state.action) {
        case RandomForestLearner::ACTION_START_FOREST:
            std::cout << "Start random forest training" << "\n";
